...
author: "jeff smith and R. Fredrick Inglis"
output: 
  html_document:
    toc: true
    toc_depth: 2
...
Our reported case data comes from the [Johns Hopkins CSSE]() and our testing data comes from [The Covid Testing Project](). All of our code is available on [Github](https://github.com/matryoshkev/arch-covid). 
